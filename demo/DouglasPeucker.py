# -*- coding: utf-8 -*-
"""
Created on Mon Jun  3 15:47:37 2019
...
def optputResult(fileName):
    ...
    result=pd.concat([the_id_dataframe,gnss_data],axis=1)
    '''
    #对全部数据建立GnssData对象
    all_gnss_data=[]
    ...
    output=open(fileName.replace('.txt','')+'_after.txt','w')
